...
module.exports = (function(){
    ...
    var proto = {
        ...
        /*_initPrototype: function(  ){
            ...
            this._EventList.prototype = { eventList: (new tmp()).on( this.__listeners ).eventList };
        },*/
        /*
